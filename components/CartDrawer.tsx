...
const CartDrawer: React.FC<CartDrawerProps> = ({ isOpen, onClose, cart, onRemove }) => {
  ...
  return (
    ...
    >
      ...
      {/* Drawer */}
      <div
        className={`relative w-full max-w-md bg-dark-800 h-full shadow-2xl border-l border-gray-800 transform transition-transform duration-300 ${
        ...
        <div className="flex flex-col h-full">
                ...
                <div key={item.id} className="flex gap-4 bg-dark-700 p-4 rounded-lg">
                   ...
                   <div className="flex-1">
                     ...
                     <div className="flex justify-between items-center mt-2">
                       <span className="text-codered-500 font-bold">KES {item.price.toLocaleString()}</span>
                       <button 
          ...
          <div className="p-6 border-t border-gray-700 bg-dark-900">
            <div className="flex justify-between items-center mb-4">
              ...
              <span className="text-2xl font-bold font-heading">KES {total.toLocaleString()}</span>
            </div>
            <button 
